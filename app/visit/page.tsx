            ...
            <form ref={formRef} className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="form-group flex flex-col md:flex-row gap-6 relative z-40">
                <div className="flex-1 border-b border-roast/20 relative group">
                  ...
                  <select className="w-full bg-transparent py-3 text-roast focus:outline-none transition-colors serif text-lg md:text-xl appearance-none cursor-pointer">
              ...
              <div className="form-group border-b border-roast/20 relative group">
                <label className="monolith text-[9px] uppercase tracking-widest opacity-50 block mb-2 transition-opacity group-focus-within:opacity-100">Message (Optional)</label>
                <textarea 
                  rows={2}
              ...
              <div className="form-group pt-8">
                <button 
                  type="submit" 
                  className="w-full bg-roast text-napkin py-5 pt-6 rounded-full monolith text-[10px] uppercase tracking-[0.3em] hover:bg-crema hover:text-roast transition-all duration-500 transform hover:-translate-y-1 shadow-[0_10px_40px_rgba(0,0,0,0.1)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.2)]"
                >
                  Send Inquiry
                </button>
              </div>
